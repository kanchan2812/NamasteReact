...
const Header=()=>{
    return(
        <div className="header">
            ...
            <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgTr37uxG9H0d0pYl2Pkq2P--MrnVcVlp5Ig&s" />
            </div>
